...
CREATE TABLE public.ethscriptions (
    ...
    attachment_content_type character varying(1000),
...
--
-- Name: index_ethscription_attachments_on_content_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_ethscription_attachments_on_content_type ON public.ethscription_attachments USING btree (content_type);
...
--
-- Name: index_ethscriptions_on_attachment_content_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_ethscriptions_on_attachment_content_type ON public.ethscriptions USING btree (attachment_content_type);
...
--
-- Name: index_ethscriptions_on_attachment_sha_not_null; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_ethscriptions_on_attachment_sha_not_null ON public.ethscriptions USING btree (attachment_sha) WHERE (attachment_sha IS NOT NULL);
...
--
-- Name: inx_ethscriptions_on_blk_num_tx_index_with_attachment_not_null; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX inx_ethscriptions_on_blk_num_tx_index_with_attachment_not_null ON public.ethscriptions USING btree (block_number, transaction_index) WHERE (attachment_sha IS NOT NULL);
